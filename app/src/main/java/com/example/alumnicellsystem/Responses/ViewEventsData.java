...
public class ViewEventsData implements Parcelable
{
    ...
    @Expose
    private Long v;
    public final static Parcelable.Creator<ViewEventsData> CREATOR = new Creator<ViewEventsData>() {


        @SuppressWarnings({
                "unchecked"
        })
        public ViewEventsData createFromParcel(Parcel in) {
            return new ViewEventsData(in);
        }

        public ViewEventsData[] newArray(int size) {
            return (new ViewEventsData[size]);
        }

    }
            ;

    protected ViewEventsData(Parcel in) {
